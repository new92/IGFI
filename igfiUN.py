...
**THIS VERSION IS UNDER TESTING PROCESS.**

Small changes to the follow / unfollow process, error handling etc.
Not tested yet so we're not changing the stable version.
